...
export const JoinToEcoSection = (): JSX.Element => {
  return (
    <section className="relative w-full bg-[#EAF6FB]">
      {/* Kontener */}
      <div className="relative mx-auto max-w-[1280px] min-h-[400px] sm:min-h-[500px] lg:min-h-[560px] px-4 sm:px-6 lg:px-10 xl:px-12 py-8 sm:py-12 lg:py-16">
        {/* Layout: grid na dużych, układa się pionowo na małych */}
        <div className="grid items-center gap-6 sm:gap-8 lg:gap-14 lg:grid-cols-2">
          {/* Lewa kolumna (tekst) */}
          <div className="relative z-[2] max-w-full lg:max-w-[720px] pr-0 lg:pr-6 xl:pr-10">
            <p className="[font-family:'Montserrat',Helvetica] font-semibold tracking-wide text-sm sm:text-base lg:text-[18px] leading-[1.3] text-[#66B6CE] uppercase mb-3">
              Budujesz startup?
            </p>

            <h2 className="font-header-h1 [font-family:'Montserrat',Helvetica] font-extrabold text-ui-black text-2xl sm:text-3xl lg:text-[44px] leading-[1.15] mb-6 sm:mb-8">
              Dołącz do ekosystemu
              <br />
              Innovations Hub Foundation
            </h2>

            <ul className="space-y-2 sm:space-y-3 text-[#0F5575] [font-family:'Montserrat',Helvetica] text-sm sm:text-base lg:text-[18px] leading-[1.55] mb-6 sm:mb-8">
              <li className="list-disc ml-4 sm:ml-6 lg:ml-8">
            ...
            <Button className="h-[48px] sm:h-[52px] px-4 sm:px-6 bg-[#0F5575] hover:bg-[#0F5575]/90 text-white rounded-[8px] [font-family:'Montserrat',Helvetica] font-semibold text-sm sm:text-base">
            ...
            <div className="relative lg:justify-self-end">
              <img
                ...
                className={[
                  ...
                  "w-full max-w-[400px] sm:max-w-[500px] md:max-w-[580px] lg:max-w-[640px] xl:max-w-[700px] h-auto mx-auto lg:mx-0",
                  // na szerokich ekranach wysuwamy obrazek w prawo poza kontener
                  "lg:max-w-none",
                  "lg:translate-x-6 xl:translate-x-10 2xl:translate-x-16",
